! function (t) {
            ...
            function () {
                ...
                (t = Array.prototype.slice.call(t)).forEach((function (t) {
                    t.addEventListener("click", (function (t) {
                        var r = t.currentTarget.getAttribute("data-target") || t.currentTarget.getAttribute("href") || "#default-drawer",
                ...
                (r = Array.prototype.slice.call(r)).forEach((function (t) {
                    t.addEventListener("mdk-drawer-change", (function (t) {
                        if (t.target.mdkDrawer) {
                            ...
                            var r = document.querySelector('[data-target="#' + t.target.id + '"]');
                            r && r.classList[t.target.mdkDrawer.opened ? "add" : "remove"]("active")
                        }
                    }))
                })), $(".sidebar .collapse").on("show.bs.collapse", (function (t) {
                    t.stopPropagation();
                    var r = $(this).parents(".sidebar-submenu").get(0) || $(this).parents(".sidebar-menu").get(0);
                    $(r).find(".open").find(".collapse").collapse("hide"), $(this).closest("li").addClass("open")
    ...
    17: function (t, r, n) {
        var e = n(4),
            ...
            a = function (t, r, n) {
                ...
                for (f in v && (n = r), n) l = ((s = !d && b && void 0 !== b[f]) ? b : n)[f], p = g && s ? c(l, e) : h && "function" == typeof l ? c(Function.call, l) : l, b && u(b, f, l, t & a.U), m[f] != l && i(m, f, p), h && x[f] != l && (x[f] = l)
            };
    ...
    18: function (t, r, n) {
        ...
        r.f = n(12) ? Object.defineProperty : function (t, r, n) {
    ...
    193: function (t, r, n) {
        ...
        n.r(r);
        n(163), n(164), n(165);
        domFactory.handler.autoInit(), $('[data-toggle="tooltip"]').tooltip(), $(".search-form input").on("focus", (function () {
    ...
    48: function (t, r, n) {
        var e = n(6)("unscopables"),
            o = Array.prototype;
        null == o[e] && n(16)(o, e, {}), t.exports = function (t) {
            o[e][t] = !0
        }
    },
    49: function (t, r, n) {
    ...
    67: function (t, r, n) {
        ...
        t.exports = function (t, r) {
            ...
            return function (r, c, v) {
                for (var y, h, g = i(r), b = o(g), m = e(c, v, 3), x = u(b.length), w = 0, S = n ? d(r, x) : a ? d(r, 0) : void 0; x > w; w++)
